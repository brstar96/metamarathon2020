...
class EfficientUnet(nn.Module):
    ...
    def forward(self, x):
        input_ = x
        print('input_shape in efficientunet.py:', input_.shape)

        blocks = get_blocks_to_be_concat(self.encoder, x) # encoder: efficientNet
        _, x = blocks.popitem()
        ...
        print('shape of x in layers.py: ', x.shape)
